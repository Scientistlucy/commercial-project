...
$select_data="SELECT invoice_number,amount_due FROM user_orders WHERE order_id=$order_id";
$run_query=mysqli_query($con,$select_data);
...
<body class="bg-secondary">
    <h1 class="text-center text-light">Confirm Payment    
    </h1>
...
<div class="form-outline my-4 text-center w-50 m-auto">
   <input type="Submit" class="bg-primary py-2 px-3 border-0" value="confirm" name="confirm_payment">
